...
Disable RDP if not required, or restrict access via VPN and enforce Network Level Authentication (NLA).
Implement regular vulnerability scanning to catch unpatched services proactively.
